...
<body>
   ...
   <main>
      ...
      <!-- vai ter que ser feito algo em JS aqui, criar o HTML direto com PHP
      não funciona. Infelizmente minhas capacidades 
      em programação não chegam nesse nível ainda. Boa sorte. -->
